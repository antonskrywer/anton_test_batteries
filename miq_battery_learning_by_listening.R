  ...
  if(language == "de"){
    psychTestR::join(
      psychTestR::text_input_page(
        label = "id",
        prompt = "Gib bitte Deine Matrikelnummer als ID ein",
        placeholder = "z.B. 8002383"
      ))
  }
  else{
    psychTestR::join(
...
miq_battery  <- function(title = "Testbatterie Musikalisches Hören",
                               documentation = "miq_lbl",
                               admin_password = "intelligence",
